...
class Producto(models.Model):
    ...
    def precio_por_litro(self):
        """Alias de compatibilidad para el antiguo nombre del campo."""
        return self.precio_litro

    @precio_por_litro.setter
    def precio_por_litro(self, value):
        self.precio_litro = value

    @property
    def stock(self):
        """Alias de compatibilidad para el antiguo campo de stock."""
        return self.stock_litros

    @stock.setter
    def stock(self, value):
        self.stock_litros = value
